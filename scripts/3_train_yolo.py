"""
Script untuk training YOLOv11 dengan dataset kersen
...
EPOCH = 100             # Sedikit lebih banyak epoch untuk augmentasi
...
print(f"⏱️  Estimasi waktu: 1-4 jam di CPU\n")

# Load model
model = YOLO('yolo11n.pt')  # Menggunakan YOLOv11 small
